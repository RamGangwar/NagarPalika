...
namespace NagarPalika.Application.Queries.RNLPropertys { public class GetRNLPropertyByFilterQuery : PagingRquestModel, IRequest<PagingModel<RNLPropertyVM>> {public int RNLPropertyId {get; set;}
