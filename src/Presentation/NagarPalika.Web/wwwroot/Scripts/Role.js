$(document).on('submit', '#frmAddEditRole', function (e) {
    debugger;
    e.preventDefault();
    if ($(this).valid()) {
            ...
            success: function (response) {
                ...
                if (response == null) {
                    ...
                    swal({
                        ...
                        window.location.href = "/Masters/RoleList";
                    });
...
function bindRoleList() {
    ...
    if ($.fn.DataTable.isDataTable('#tblRoleList')) {
        ...
        columns: [
            ...
            },
            {
                ...
                "render": function (data, type, row, meta) {
                    ...
                    renderBody = renderBody + '<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#addRole" onclick="AddEditRoles(' + data + ')"><img src="../img/edit.png" alt=""></a>';

                    renderBody = renderBody + '<a href="javascript:void(0)" onclick="DeleteRoles(' + data + ')" class="btnDelOrg"><img src="../img/delete.png" alt=""></a>';
...
function AddEditRoles(id) {
    ...
    $.ajax({
        type: 'GET',
        url: '/Masters/AddEditRole',
        data: { Id: id },
        datatype: "content/html",
        success: function (data) {
            debugger;
            $('#addRole').empty().html(data);
            $.validator.unobtrusive.parse($("#frmAddEditRoles"));
            $('#addRole').show();
